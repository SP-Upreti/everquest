...
const Page = ({ params }: any) => {
  ...
  return (
    <div>
      <main className="bg-[url('/bgservices.jpg')]  bg-cover bg-fixed bg-center bg-black/80 opacity-100 bg-blend-darken">
        <div className="grid lg:grid-cols-11 grid-cols-1 gap-6 py-32 lg:w-11/12 w-11/12 3xl:w-9/12 mx-auto text-white">
          <div className="lg:col-span-8 ">
            <h2 className="text-2xl title font-bold">
              Rafting/
              <span className="text-primary2">BhoteKoshi Expedition</span>
            </h2>
                  ...
                  >
                    <div className=" w-full flex justify-start gap-5">
                      ...
                      <div className="font-medium text-[15px]">
                        <span className="font-bold md:text-xl text-base uppercase title">
                          {item.title}:
                        </span>{" "}
                        <span
            ...
            <div className="w-full mt-8 mx-auto p-3 md:p-10   bg-zinc-800 bg-opacity-35 border  rounded-lg">
              ...
              {ItineraryData.map((item, index) => (
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <h2 className="font-medium flex gap-2 items-end text-xl">
                        <span className="cursor-pointer font-bold lg:text-xl text-base whitespace-nowrap px-2 rounded-md bg-primary2/80 text-black">
                          {item.day}
                        </span>
                      </h2>
                      <h2 className="text-sm md:text-lg font-medium py-6">
                        {item.title}
                      </h2>
                    </div>
                  ...
                  >
                    <div className="">
                      <p className="  font-medium xs:text-sm text-xs text-light">
                        {item.desc}
                      </p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="mt-4 w-full h-full flex flex-col gap-2">
                  {Inclusion.map((item, index) => (
                    <div
                      key={index}
                      className="w-full  md:py-4 py-1  overflow-hidden   flex justify-center items-center"
                    >
          ...
          <div className="lg:col-span-3 md:sticky top-[5rem] h-fit  rounded-md text-white">
            <div className="md:col-span-3 col-span-9 sticky top-[5rem]">
              ...
              <div className=" rounded-md py-4 mt-8 bg-zinc-100 text-black border-2 border-primary2 ">
                <h2 className="title uppercase font-extrabold text-lg text-center">
                  Meet our Expert
                </h2>
                <figure className="">
                  <Image
                    ...
                    width={1000}
                    height={1000}
                    className="rounded-full h-[7em] w-[7em] mx-auto my-4 border-2 border-green-500 "
                  />
                </figure>
                <h2 className="font-bold text-xl text-center">Prem Gurung</h2>
                <h2 className="font-bold text-md text-center flex justify-center items-center gap-2">
                  <Icon icon="logos:whatsapp-icon" className="text-xl" />
                  <span className="font-bold"> 9874561236</span>
                </h2>
              </div>
            </div>
          </div>

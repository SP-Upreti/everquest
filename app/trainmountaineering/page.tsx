  ...
  return (
    <main>
      ...
      <div className="w-10/12 mx-auto my-12">
        {/* <h1 className="text-4xl font-bold title tracking-wide italic text-secondary-500 mb-4">
          Mountainerring
        </h1> */}
        <Title text="Mountaineering" fontSize="!text-[2vw]" textalign="text-left" />
        <p className="text-md font-medium text-secondary-400 mt-6">
          Mountaineering is an exhilarating adventure sport that involves
          climbing mountains and navigating challenging terrains. It combines
          physical endurance, technical skill, and a deep appreciation for
          nature's beauty. Here is a brief introduction to the key aspects of
          mountaineering Mountaineering, often referred to as climbing, is the
          sport of ascending mountains. It encompasses various activities,
          including rock climbing, ice climbing, and trekking at high altitudes.
        </p>
